...
(1) Open Eclipse, create a Dynamic Web Project `ManyToMany`. Choose generate web.xml.
...
mysql> insert into tb_class(c_name,c_credit) values('Math',1);
mysql> insert into tb_class(c_name,c_credit) values('Computer',2);
```
...
public class Course {
    ...
    public Classes(Integer id, String name, Integer credit, List<Student> students) {
        this.id = id;
        this.name = name;
        this.credir = credit;
...
<mapper namespace="labex.mybatis.manytomany.mapper.StudentMapper">
    ...
    <select id="selectStudentCourse" resultMap="classmap">
...
![](C:\Users\Administrator\Desktop\Java lab\MyBatis\3)
