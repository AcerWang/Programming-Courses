...
Modules in the experiment includes
...
The operation of this section  are relatively simple, only need to try each module of the method in the interactive environment of Python 3.
...
If you have written a crawlers, you shall be familiar with this library. Before the `requests` library appears, the network request usually uses the ` urllib` in the standard library.After `request`, it normally becomes the actual standard library of network request in Python. 
...
This section of the experiment introduces modules of some of the follow-up projects
